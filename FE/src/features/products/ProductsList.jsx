    ...
    <div className='text-xl mt-4 container grid grid-cols-3'>
      ...
      <div className='col-span-2'>
        <div className='flex flex-col justify-start'>
          {keycloak.hasRealmRole('admin') && <button className='bg-zinc-700 hover:bg-zinc-600 text-zinc-50 mb-4 p-2 rounded' onClick={() => navigate('/add')}>{polish ? 'Dodaj Produkt' : 'Add Product'}</button>}
